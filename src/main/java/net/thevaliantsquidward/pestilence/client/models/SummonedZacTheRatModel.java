...
public class SummonedZacTheRatModel<T extends SummonedZac> extends HierarchicalModel<T> {
	...
	public SummonedZacTheRatModel(ModelPart root) {
	...
	@Override
	public void setupAnim(SummonedZac entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
