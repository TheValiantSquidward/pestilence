...
public class PestilenceItemModelProvider extends ItemModelProvider {

    public PestilenceItemModelProvider(GatherDataEvent event) {
        super(event.getGenerator().getPackOutput(), Pestilence.MOD_ID, event.getExistingFileHelper());
    }
    ...
    protected void registerModels() {
        ...
        for (Item item : BuiltInRegistries.ITEM) {
            if (item instanceof SpawnEggItem && Objects.requireNonNull(ForgeRegistries.ITEMS.getKey(item)).getNamespace().equals(Pestilence.MOD_ID)) {
